...
JsonObjectCpp::JsonObjectCpp(const JsonObject* value) : m_value{ value } {}
...
[[nodiscard]] static bool json_value_eq_impl(const JsonValue* const json_value1,
                                             const JsonValue* const json_value2) {
...
JsonValueCpp::JsonValueCpp(const JsonValue* value) : m_value{ value } {}

[[nodiscard]] bool JsonValueCpp::operator==(const JsonValueCpp& json_value2) const {
	return json_value_eq_impl(this->m_value, json_value2.m_value);
}

[[nodiscard]] bool JsonValueCpp::operator==(const JsonValue* json_value2) const {
	return json_value_eq_impl(this->m_value, json_value2);
}
